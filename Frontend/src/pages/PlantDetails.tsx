...
const PlantDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <div className="mt-8 flex gap-4">
              <button 
                ...
                className="flex-1 bg-gray-900 text-white py-4 rounded-2xl font-black text-lg hover:bg-green-600 transition shadow-xl"
              >
                Place Order
              </button>
              <button 
      ...
      {/* Footer එක හරියටම පතුලේ තියෙනවා */}
      <Footer />
{showModal && (
  <OrderModal 
    plant={plant} 
    onClose={(updatedStock) => {
      if (updatedStock !== undefined) {
        setPlant({ ...plant, stock: updatedStock }); // UI එක update වෙනවා
      }
      setShowModal(false);
    }} 
  />
